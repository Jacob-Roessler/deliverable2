...
function getTotal(buttonClicked){
    var price = buttonClicked.parentElement.getElementsByClassName('price')[0].innerHTML;
...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    for(var i = 0; i < books.length; i++)
    {
        ...
        button.addEventListener('click', function(event) {
            ...
            var text = document.createTextNode(buttonClicked.parentElement.getElementsByTagName('h2')[0].innerHTML);
            ...
            if(! inCart(cart, title))
            {
                ...
                document.getElementsByClassName('total')[0].innerHTML = 'Total: $' + getTotal(buttonClicked);
            }
            else
            {
    ...
    clearButton.addEventListener('click', function(event) {
        content = document.getElementsByClassName('cart-content')[0].getElementsByTagName('ul')[0];
        content.innerHTML = '';
